...
const VigorousVideos=({})=> {
  ...
  return (
   ...
   />       
        <Text>Level 3 Session 1(Range of Motion)</Text>
            <Button
 ...
 />         
            ...
            <Text>Level 3 Session 2(Strength Activities)</Text>
          <Button
 ...
 />         
             <Text>Level 3 Session 3(Healing Sounds)</Text>
          <Button
  ...
  onPlaybackStatusUpdate={setStatusThirdVideo}
 />         
             <Text>Level 3 Session 4(Organ Health)</Text>
          <Button
